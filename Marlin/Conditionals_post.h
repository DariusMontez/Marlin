...
#define CONDITIONALS_POST_H
  ...
  #define X_CENTER double((X_MIN_POS + X_MAX_POS) * 0.5)
  #define Y_CENTER double((Y_MIN_POS + Y_MAX_POS) * 0.5)
  #define Z_CENTER double((Z_MIN_POS + Z_MAX_POS) * 0.5)

  /**
   * CoreXY, CoreXZ, and CoreYZ - and their reverse
   */
  #define CORE_IS_XY (OPTION_ENABLED(COREXY) || OPTION_ENABLED(COREYX))
  #define CORE_IS_XZ (OPTION_ENABLED(COREXZ) || OPTION_ENABLED(COREZX))
  #define CORE_IS_YZ (OPTION_ENABLED(COREYZ) || OPTION_ENABLED(COREZY))
  #define IS_CORE (CORE_IS_XY || CORE_IS_XZ || CORE_IS_YZ)
      ...
      #define CORE_AXIS_2 C_AXIS
    #endif
    #if (OPTION_ENABLED(COREYX) || OPTION_ENABLED(COREZX) || OPTION_ENABLED(COREZY))
      #define CORESIGN(n) (-(n))
    #else
      #define CORESIGN(n) (n)
    #endif
  ...
  #define IS_SCARA (OPTION_ENABLED(MORGAN_SCARA) || OPTION_ENABLED(MAKERARM_SCARA))
  #define IS_KINEMATIC (OPTION_ENABLED(DELTA) || IS_SCARA)
  ...
  #elif OPTION_ENABLED(BED_CENTER_AT_0_0)
   ...
   */
  #define HOMING_Z_WITH_PROBE (HAS_BED_PROBE && Z_HOME_DIR < 0 && OPTION_ENABLED(Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN))
   ...
   */
  #if OPTION_ENABLED(CONFIG_STEPPERS_TOSHIBA)
    #ifdef CPU_32_BIT
  ...
  #if OPTION_ENABLED(ULTIPANEL) && OPTION_DISABLED(ELB_FULL_GRAPHIC_CONTROLLER)
  ...
  #ifdef __SAM3X8E__
    #define HEATER_USES_AD595 (OPTION_ENABLED(HEATER_0_USES_AD595) || OPTION_ENABLED(HEATER_1_USES_AD595) || OPTION_ENABLED(HEATER_2_USES_AD595) || OPTION_ENABLED(HEATER_3_USES_AD595))
  #endif

  /**
   * Flags for PID handling
   */
  #define HAS_PID_HEATING (OPTION_ENABLED(PIDTEMP) || OPTION_ENABLED(PIDTEMPBED))
  #define HAS_PID_FOR_BOTH (OPTION_ENABLED(PIDTEMP) && OPTION_ENABLED(PIDTEMPBED))
   ...
   */
    ...
    #endif
    #if !defined(HOTEND_OFFSET_Z) && (OPTION_ENABLED(DUAL_X_CARRIAGE) || OPTION_ENABLED(SWITCHING_EXTRUDER))
   ...
   */
  #if OPTION_ENABLED(ENDSTOPPULLUPS)
    #if OPTION_ENABLED(USE_XMAX_PLUG)
      #define ENDSTOPPULLUP_XMAX
    #endif
    #if OPTION_ENABLED(USE_YMAX_PLUG)
      #define ENDSTOPPULLUP_YMAX
    #endif
    #if OPTION_ENABLED(USE_ZMAX_PLUG)
      #define ENDSTOPPULLUP_ZMAX
    #endif
    #if OPTION_ENABLED(USE_XMIN_PLUG)
      #define ENDSTOPPULLUP_XMIN
    #endif
    #if OPTION_ENABLED(USE_YMIN_PLUG)
      #define ENDSTOPPULLUP_YMIN
    #endif
    #if OPTION_ENABLED(USE_ZMIN_PLUG)
  ...
  #define HAS_BUZZER (PIN_EXISTS(BEEPER) || OPTION_ENABLED(LCD_USE_I2C_BUZZER))
  #define HAS_CASE_LIGHT (PIN_EXISTS(CASE_LIGHT))

  #define HAS_MOTOR_CURRENT_PWM (PIN_EXISTS(MOTOR_CURRENT_PWM_XY) || PIN_EXISTS(MOTOR_CURRENT_PWM_Z) || PIN_EXISTS(MOTOR_CURRENT_PWM_E))

  #define HAS_TEMP_HOTEND (HAS_TEMP_0 || OPTION_ENABLED(HEATER_0_USES_MAX6675))

  #define HAS_THERMALLY_PROTECTED_BED (HAS_TEMP_BED && HAS_HEATER_BED && OPTION_ENABLED(THERMAL_PROTECTION_BED))
   ...
   */
  #if OPTION_ENABLED(INVERTED_HEATER_PINS)
  ...
  #endif
  #if HAS_HEATER_BED
    #if OPTION_ENABLED(INVERTED_BED_PINS)
  ...
  #if OPTION_ENABLED(INVERTED_FAN_PINS)
  ...
  #define PROBE_PIN_CONFIGURED (HAS_Z_MIN_PROBE_PIN || (HAS_Z_MIN && OPTION_ENABLED(Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN)))

  #define HAS_BED_PROBE (PROBE_SELECTED && PROBE_PIN_CONFIGURED && OPTION_DISABLED(PROBE_MANUALLY))
   ...
   */
  #if HAS_BED_PROBE
    #if OPTION_ENABLED(ENDSTOPPULLUPS) && HAS_Z_MIN_PROBE_PIN
   ...
   */
  #define ABL_PLANAR (OPTION_ENABLED(AUTO_BED_LEVELING_LINEAR) || OPTION_ENABLED(AUTO_BED_LEVELING_3POINT))
  #define ABL_GRID   (OPTION_ENABLED(AUTO_BED_LEVELING_LINEAR) || OPTION_ENABLED(AUTO_BED_LEVELING_BILINEAR))
  #define HAS_ABL    (ABL_PLANAR || ABL_GRID || OPTION_ENABLED(AUTO_BED_LEVELING_UBL))

  #define PLANNER_LEVELING      (HAS_ABL || OPTION_ENABLED(MESH_BED_LEVELING))
  #define HAS_PROBING_PROCEDURE (HAS_ABL || OPTION_ENABLED(Z_MIN_PROBE_REPEATABILITY_TEST))
   ...
   */
    ...
    #define MAX_PROBE_X (_min(X_MAX_POS, X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER))
    #define MIN_PROBE_Y (max(Y_MIN_POS, Y_MIN_POS + Y_PROBE_OFFSET_FROM_EXTRUDER))
    #define MAX_PROBE_Y (_min(Y_MAX_POS, Y_MAX_POS + Y_PROBE_OFFSET_FROM_EXTRUDER))
  #endif
  ...
  #define STEP_PULSE_CYCLES ((MINIMUM_STEPPER_PULSE) * CYCLES_PER_MICROSECOND)
    ...
    #define HAS_FOLDER_SORTING (FOLDER_SORTING || OPTION_ENABLED(SDSORT_GCODE))
  #endif
  ...
  // Use double instead of double. Needs profiling.
  #if defined(ARDUINO_ARCH_SAM) && OPTION_ENABLED(DELTA_FAST_SQRT)
    #undef ATAN2
    #undef FABS
    #undef POW
    #undef SQRT
