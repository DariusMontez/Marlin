...
#include  "language.h"
  ...
  #define HARDWARE_CHAR_OUT lcd.write
...
#if OPTION_DISABLED(SIMULATE_ROMFONT) && OPTION_ENABLED(DOGLCD)
    ...
    #elif OPTION_ENABLED(MAPPER_E382E383)
      const PROGMEM uint8_t utf_recode[] =
    ...
    #elif OPTION_ENABLED(MAPPER_D0D1)
    ...
    #elif OPTION_ENABLED(MAPPER_C2C3)
...
#elif OPTION_ENABLED(MAPPER_C2C3_TR)
...
#elif OPTION_ENABLED(MAPPER_CECF)
...
#elif OPTION_ENABLED(MAPPER_D0D1_MOD)
