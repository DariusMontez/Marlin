...
#if OPTION_ENABLED(SANGUINOLOLU_V_1_2)
...
//
    ...
    #if OPTION_ENABLED(U8GLIB_ST7920) // SPI GLCD 12864 ST7920 ( like [www.digole.com] ) For Melzi V2.0
  ...
  #define BTN_EN2               10
      ...
      #define BTN_ENC           30
    #endif
  #elif OPTION_ENABLED(OLED_PANEL_TINYBOY2)
    #define BTN_ENC             28
    #define LCD_SDSS            -1
